...
if(header){
  header.innerHTML='<a class="nav-slot" href="/">상품 목록</a><a class="nav-slot" href="/cart.html">장바구니</a><a class="nav-slot" id="auth-action" href="/login.html">로그아웃</a><a class="nav-slot" id="signup-action" href="/signup.html">회원가입</a><a class="nav-slot" href="/account.html">마이페이지</a><span class="auth-status" id="auth-status">로그인 안 함</span>';
